...
/**
 * Client ke IAM (via Gateway) untuk entitlements.
 * Disusun ala catalog: berada di infrastructure/iam dan akhiran *Impl.
 */
public class IamEntitlementClientImpl implements EntitlementClient {

    private final WebClient iamWebClient;
    private final int responseMs;
    private final String serviceToken;

    public IamEntitlementClientImpl(WebClient iamWebClient, int responseMs, String serviceToken) {
