...
public class AssignPermissionToRoleCommand {
    ...
    public AssignPermissionToRoleCommand(RolePermissionPort rolePerm, UserRolePort userRole, EntitlementVersionPort version) { this.rolePerm = rolePerm; this.userRole = userRole; this.version = version; }
