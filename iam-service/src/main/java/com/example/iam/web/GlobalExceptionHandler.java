...
public class GlobalExceptionHandler {
    ...
    // 400 – body JSON tidak valid / gagal parse
    ...
    // 400 – validasi @Valid pada DTO body
    ...
    // 409 – konflik data (misal unique constraint)
    ...
    // 403 – akses ditolak (fallback kalau belum tertangkap Security handler)
    ...
    // 500 – tak terduga (DEV: verbose jika app.errors.verbose=true)
