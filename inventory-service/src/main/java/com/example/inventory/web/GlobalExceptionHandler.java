...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> typeMismatch(HttpServletRequest req, MethodArgumentTypeMismatchException ex) {
        Map<String, Object> extra = Map.of(
                "parameter", ex.getName(),
                "value", String.valueOf(ex.getValue()),
                "requiredType", ex.getRequiredType() != null ? ex.getRequiredType().getSimpleName() : ""
        );
        return respond(req, HttpStatus.BAD_REQUEST, "bad_request:type_mismatch", "Invalid parameter type", ex, extra);
    }
    ...
    private ResponseEntity<?> respond(HttpServletRequest req,
        ...
        var body = errors.build(req, status, code, message, ex, extra,
